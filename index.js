...
const productContainer = document.querySelector(".cardsWraper");

const iconVerMas = document.getElementById("seeMorePizzas");
...
const createProductTemplate = (product) => {
  ...
  <img src="${cardImg}" alt="${name}" class="img-card">
    ...
    <button class="button">Pedir por $${bid}</button>
</div>
`;
};
